...
public class SftpUtil {
	 ...
	 * @throws Exception 异常
	 */
	public static File download(final String downloadFile, final String saveFile, final ChannelSftp sftp) throws Exception {
	 ...
	 * @throws Exception 异常
	 */
	private static void uploadFile(final String srcFile, final String dir, final String fileName, final ChannelSftp sftp) throws Exception {
		mkdir(dir, sftp);
		sftp.cd(dir);
	...
	public static void main(String[] args) throws Exception {
		String upload_directory = "/epp/fundpayment/70180850/merchantPurchaseDocument/";
//		 String host = "fdfs.suning.com";
//		 String host = "58.240.86.70";
		 String host = "103.255.93.70";
//		String host = "58.213.14.9";
		String username = "operator_70180850";
		String password = "fc5$OJuwa8fl";
		int port = 22;
		...
		while (++i <= 10) {
			ChannelSftp sftp = null;
			try {
				sftp = getSftpConnect(host, port, username, password);
				System.out.println(i+":"+upload_directory);
				Vector<ChannelSftp.LsEntry> vector = sftp.ls(upload_directory);
				for (ChannelSftp.LsEntry ftp : vector) {
					System.err.println(ftp.getFilename());
				}
			} catch (Exception e) {
				failNum++;
				e.printStackTrace();
